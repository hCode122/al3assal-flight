...
const LocationCard = ({cardData, type, onClick}) => {
    
    return (
        <div onClick={e => { e.stopPropagation(); onClick()}} className="flex gap-2 items-center  px-2 py-2 bg-[#F7F7FA] border-b-[1px] last:border-0 border-[#7A7A7A] hover:bg-blue-200">
